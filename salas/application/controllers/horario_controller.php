...
class Horario_controller extends Controller {//@
    private $data;
	private $myModel='Horario_model';//@
    
    function Horario_controller(){//@
        parent::Controller();
	...
	function cargaModulo($nombreTab='',$inputBuscador=false,$keyTab='',$keyTab=''){//******************@ AGREGAR TANTOS KEYTAB COMO FK TENGA LA TABLA
		...
		$this->data['controller']="horario_controller";//@lowercase
		$this->data['nombreModulo']="Horario";//@
        $this->load->view('backend/horario',$this->data);//@
    }
