...
class Seccion_controller extends Controller {//@
    private $data;
	private $myModel='Seccion_model';//@
    
    function Seccion_controller(){//@
        parent::Controller();
	...
	function cargaModulo($nombreTab='',$inputBuscador=false,$keyTab='',$keyTab='',$keyTab=''){//******************@ AGREGAR TANTOS KEYTAB COMO FK TENGA LA TABLA
		...
		$this->data['controller']="seccion_controller";//@lowercase
		$this->data['nombreModulo']="Seccion";//@
        $this->load->view('backend/seccion',$this->data);//@
    }
