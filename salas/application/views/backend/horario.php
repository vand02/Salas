...
<div id="dataForm<?=$nombreTab?>" style="display:none">
	...
	<table  class="tabla_form" >
		...
		<tr>
			<th>DIA</th>
			<td><input type="text" size="30" id="dia" name="dia" value="" class="required"  ></input></td>
		</tr>
		<tr>
			<th>HORA</th>
			<td><input type="text" size="30" id="hora" name="hora" value="" class="required"  >Ejemplo "16:00-17:20"</input></td>
		</tr>
		<tr>
			<th>SALA</th>
			<td><input type="text" size="30" id="sala" name="sala" value="" class="required"  ></input></td>
		</tr>
		<tr>
			<th>ESTADO</th>
			<td><input type="text" size="30" id="estado" name="estado" value="" class="required"  >Ejemplo "activo" o "suspendido"</input></td>
		</tr>
...
var mygrid<?=$nombreTab?>=jQuery("#grid<?=$nombreTab?>").jqGrid({
    ...
    width:900,
    height:'auto',
    colNames:['ID','USUARIO_ID','ASIGNATURA_ID','SECCION_ID','DIA','HORA','SALA','ESTADO'],//@
    colModel:[//@
...
function grid<?=$nombreTab?>Reload(){//@
	...
	//@
	jQuery("#grid<?=$nombreTab?>").setGridParam({url:"index.php?/<?=$controller?>/grid/<?=$keyTab?>",postData:{"livesearch":true,"f_id":f_id,"f_usuario_id":f_usuario_id,"f_asignatura_id":f_asignatura_id,"f_seccion_id":f_seccion_id,"f_dia":f_dia,"f_hora":f_hora,"f_sala":f_sala,"f_estado":f_estado},page:1}).trigger("reloadGrid");
}
//////////////////////
<?php } ?>
